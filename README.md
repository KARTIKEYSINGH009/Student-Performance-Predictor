...
**Overview:**
This project demonstrates a basic machine learning classification model built using Python.
It generates a synthetic dataset with random values for marks, attendance, and study hours, then trains a Logistic Regression model to predict the performance outcome.
...
0 (Fail) | 0.4000    | 0.0513 | 0.0909   | 39
1 (Pass) | 0.8746    | 0.9885 | 0.9281   | 261
Accuracy: 0.8667 (300 samples)
Macro Avg: 0.6373 | 0.5199 | 0.5095
Weighted Avg: 0.8129 | 0.8667 | 0.8192

**Result:**
The model achieved 86.67% accuracy and performs consistently in predicting whether a student will pass or fail.
It’s a solid beginner-level AI/ML implementation using only basic Python libraries.
